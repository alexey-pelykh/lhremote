...
| [008](docs/adr/008-readiness-binding-and-empty-vs-error-contract.md) | Post-detail readiness binding and the empty-vs-error contract | `packages/core/src/linkedin/dom-variant.ts`, `packages/core/src/linkedin/corroboration.ts`, `packages/core/src/cdp/wait-for-post-load.ts` |
