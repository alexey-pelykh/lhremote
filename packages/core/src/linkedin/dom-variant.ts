...
/**
 * The `cause` for a `DOMVariantUnsupportedError` raised at EXTRACTION
 * time — after that surface's readiness gate has already gone green.
 *
 * ## What this states that the class's own message cannot
 *
 ...
 *
 * No page content, ever. `errorMessage()` renders a cause with no
